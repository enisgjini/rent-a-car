				...
				<div class="col-md-10">
					...
					<form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
						...
						<div class="form-group">
							<h6>Zgjidhni faqen</h6>
							<div class="col-sm-8">
								<select class="form-select" name="menu1" onChange="MM_jumpMenu('parent',this,0)">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">Faqje e zgjedhur për perditsim</label>
							<div class="col-sm-8">
								<?php
