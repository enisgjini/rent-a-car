								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) {				?>
										<tr>
											...
											<td>
												<a class="btn btn-danger" href="manage-subscribers.php?del=<?php echo $result->id; ?>" onclick="return confirm('A doni të fshini ?');"><i class="fa fa-close"></i></a>
											</td>
										</tr>
								<?php $cnt = $cnt + 1;
									}
