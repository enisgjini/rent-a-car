									...
									foreach ($results as $result) {				?>
										<tr>
											...
											<?php } else { ?>
												...
												<td><a class="btn btn-primary" href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('A doni vërtet të lexoni')">Në pritje ...</a>
												</td>
											<?php } ?>
										</tr>
								<?php $cnt = $cnt + 1;
